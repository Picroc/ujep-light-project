...
var app = (function () {
    ...
    function create_then_block(ctx) {
    	let div;
    	let if_block = /*source*/ ctx[2] && create_if_block_1(ctx);
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(window_1, "resize", /*onwindowresize*/ ctx[9]),
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (dirty & /*scrollValue*/ 1 && !scrolling) {
    				scrolling = true;
    				clearTimeout(scrolling_timeout);
    				scrollTo(window_1.pageXOffset, /*scrollValue*/ ctx[0]);
    				scrolling_timeout = setTimeout(clear_scrolling, 100);
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function onwindowscroll() {
    		$$invalidate(0, scrollValue = window_1.pageYOffset);
    	}

    	function onwindowresize() {
    		$$invalidate(1, windowHeight = window_1.innerHeight);
    	}
