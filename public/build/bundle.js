...
var app = (function () {
    ...
    /* src/components/animationLogo.svelte generated by Svelte v3.46.3 */
    ...
    /* src/components/scrollerBlock.svelte generated by Svelte v3.46.3 */
    ...
    /* src/components/animationScroller.svelte generated by Svelte v3.46.3 */
    ...
    // (208:25)      <div class='backgroundAnimation'>         {#if source}
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 208, 4, 8988);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if (if_block) if_block.m(div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(208:25)      <div class='backgroundAnimation'>         {#if source}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 210, 12, 9055);
    		},
    		m: function mount(target, anchor) {
    ...
    // (216:0) { #if scrollToBlock[frameNumber] }
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(216:0) { #if scrollToBlock[frameNumber] }",
    		ctx
    	});
    ...
    // (225:0) { #if frameMapper[scrollValue] > 1111 }
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 227, 12, 9624);
    			attr_dev(a, "href", "https://www.instagram.com/vizualove/");
    			add_location(a, file$1, 226, 8, 9564);
    			attr_dev(div, "class", "linker svelte-jin6qg");
    			add_location(div, file$1, 225, 4, 9535);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(225:0) { #if frameMapper[scrollValue] > 1111 }",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let if_block0 = /*scrollToBlock*/ ctx[4][/*frameNumber*/ ctx[1]] && create_if_block_1$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 198, 0, 8746);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
