...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", div_class_value = "scrollerBlock " + /*position*/ ctx[2] + " " + `${/*downed*/ ctx[3] ? "downed" : ""}` + " svelte-1gdafre");
    		...
    		p: function update(new_ctx, [dirty]) {
    			...
    			if (!current || dirty & /*position, downed*/ 12 && div_class_value !== (div_class_value = "scrollerBlock " + /*position*/ ctx[2] + " " + `${/*downed*/ ctx[3] ? "downed" : ""}` + " svelte-1gdafre")) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('svgSource' in $$props) $$invalidate(4, svgSource = $$props.svgSource);
    		if ('position' in $$props) $$invalidate(2, position = $$props.position);
    		if ('downed' in $$props) $$invalidate(3, downed = $$props.downed);
    	};
    	...
    	return [title, text, position, downed, svgSource];
    }
    ...
    class ScrollerBlock extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*svgSource*/ ctx[4] === undefined && !('svgSource' in props)) {
