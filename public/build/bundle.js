...
var app = (function () {
    ...
    // (206:25)      <div class='backgroundAnimation'>         {#if source}
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 206, 4, 8941);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if (if_block) if_block.m(div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(206:25)      <div class='backgroundAnimation'>         {#if source}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 208, 12, 9008);
    		},
    		m: function mount(target, anchor) {
    ...
    // (214:0) { #if scrollToBlock[frameMapper[scrollValue]] }
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(214:0) { #if scrollToBlock[frameMapper[scrollValue]] }",
    		ctx
    	});
    ...
    // (223:0) { #if frameMapper[scrollValue] > 1111 }
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 225, 12, 9655);
    			attr_dev(a, "href", "https://www.instagram.com/vizualove/");
    			add_location(a, file$1, 224, 8, 9595);
    			attr_dev(div, "class", "linker svelte-jin6qg");
    			add_location(div, file$1, 223, 4, 9566);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(223:0) { #if frameMapper[scrollValue] > 1111 }",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 196, 0, 8699);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
