...
var app = (function () {
    ...
    // (272:25)      <div class='backgroundAnimation' bind:this={scrollerInstance}
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "backgroundAnimation svelte-1xcyfe9");
    			add_location(div, file$1, 272, 4, 11238);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(272:25)      <div class='backgroundAnimation' bind:this={scrollerInstance}",
    		ctx
    	});
    ...
    // (280:0) { #if scrollToBlock[frameMapper[scrollValue]] }
    function create_if_block_1$1(ctx) {
    	...
    	scrollerblock = new ScrollerBlock({
    			props: {
    				title: /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].title,
    				text: /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].text,
    				svgSource: /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].src,
    				position: /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].position || 'left',
    				downed: /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].id === 'laser'
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*scrollValue*/ 1) scrollerblock_changes.title = /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].title;
    			if (dirty & /*scrollValue*/ 1) scrollerblock_changes.text = /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].text;
    			if (dirty & /*scrollValue*/ 1) scrollerblock_changes.svgSource = /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].src;
    			if (dirty & /*scrollValue*/ 1) scrollerblock_changes.position = /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].position || 'left';
    			if (dirty & /*scrollValue*/ 1) scrollerblock_changes.downed = /*scrollToBlock*/ ctx[3][/*frameMapper*/ ctx[5][/*scrollValue*/ ctx[0]]].id === 'laser';
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(280:0) { #if scrollToBlock[frameMapper[scrollValue]] }",
    		ctx
    	});
    ...
    // (289:0) { #if frameMapper[scrollValue] > 1111 }
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a = element("a");
    			span = element("span");
    			attr_dev(span, "class", "svelte-1xcyfe9");
    			add_location(span, file$1, 291, 12, 12002);
    			attr_dev(a, "href", "https://www.instagram.com/vizualove/");
    			add_location(a, file$1, 290, 8, 11942);
    			attr_dev(div, "class", "linker svelte-1xcyfe9");
    			add_location(div, file$1, 289, 4, 11913);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(289:0) { #if frameMapper[scrollValue] > 1111 }",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "scrollSpacer svelte-1xcyfe9");
    			add_location(div, file$1, 262, 0, 10996);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(window_1$1, "resize", /*onwindowresize*/ ctx[9]),
    					action_destroyer(styles.call(null, div, { calcHeight: /*calcHeight*/ ctx[4] }))
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function animate() {
    		if (canvas) {
    			if (!currentImg || currentImg && getSourceWithoutHost(currentImg.src) !== source) {
    				console.log('REDRAWING...', currentImg && getSourceWithoutHost(currentImg.src));
    				const img = new Image();
    				img.src = source;
    				currentImg = img;
    			}
    			...
    			if (currentImg && currentImg.complete) {
    				...
    				canvas.setAttribute('height', canvas.width * dpi);
    				canvas.setAttribute('width', canvas.height * dpi);
    				currentImg.width = canvas.width;
    				currentImg.height = canvas.height;
    		...
    		if (scrollerInstance) {
    			if (source) {
    				if (!currentImg) {
    					...
    					$$invalidate(2, scrollerInstance.innerHTML = '', scrollerInstance);
    	...
    	function onwindowresize() {
    		$$invalidate(1, windowHeight = window_1$1.innerHeight);
    	}

    	function div_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			scrollerInstance = $$value;
    			$$invalidate(2, scrollerInstance);
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('loaded' in $$props) $$invalidate(7, loaded = $$props.loaded);
    		if ('currentImg' in $$props) currentImg = $$props.currentImg;
    		if ('toUpdateImg' in $$props) toUpdateImg = $$props.toUpdateImg;
    		if ('scrollerInstance' in $$props) $$invalidate(2, scrollerInstance = $$props.scrollerInstance);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*scrollValue*/ 1) {
    			...
    			// }
    			source = scrollValue > 20
    			? `/assets/animation/animation_frame${Math.min(frameMapper[scrollValue], framesCount)}.jpg`
    			: '';
    		}
    	};
    ...
    class AnimationScroller extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { loaded: 7 });
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file, 29, 3, 883);
    			attr_dev(div_1, "class", "bubble svelte-24lus6");
    			add_location(div_1, file, 28, 2, 766);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 24, 0, 694);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
