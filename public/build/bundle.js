...
var app = (function () {
    ...
    // (199:25)      <div class='backgroundAnimation'>         {#if source}
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 199, 4, 8725);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			if (if_block) if_block.m(div, null);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "then",
    		source: "(199:25)      <div class='backgroundAnimation'>         {#if source}",
    		ctx
    	});
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 201, 12, 8792);
    		},
    		m: function mount(target, anchor) {
    ...
    // (207:0) { #if scrollToBlock[frameMapper[scrollValue]] }
    function create_if_block_1$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(207:0) { #if scrollToBlock[frameMapper[scrollValue]] }",
    		ctx
    	});
    ...
    // (216:0) { #if frameMapper[scrollValue] > 1111 }
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$1, 218, 12, 9439);
    			attr_dev(a, "href", "https://www.instagram.com/vizualove/");
    			add_location(a, file$1, 217, 8, 9379);
    			attr_dev(div, "class", "linker svelte-jin6qg");
    			add_location(div, file$1, 216, 4, 9350);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, a);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(216:0) { #if frameMapper[scrollValue] > 1111 }",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 189, 0, 8483);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
